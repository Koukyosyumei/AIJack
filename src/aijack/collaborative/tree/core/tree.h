...
struct Tree
{
    ...
    /**
     * @brief Recursively extract the vector of predictions of the training data from the specified node
     *
     ...
     * @param binary_color Color the leaf purity (red: >= 0.8, yellow: 0.8 ~ 0.7, green: 0.7 >)
