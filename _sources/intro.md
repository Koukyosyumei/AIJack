...
| Gradient descent attacks | Evasion Attack       | [example](aijack_evasion_attack.ipynb)                                                                                      | [paper](https://github.com/Koukyosyumei/AIJack/https://arxiv.org/abs/1708.06131)                                                                                                           |
| SVM Poisoning            | Poisoning Attack     | [example](aijack_poison_attack.ipynb)                                                                                       | [paper](https://github.com/Koukyosyumei/AIJack/https://arxiv.org/abs/1206.6389)                                                                                                            |
...
| -------- | ---------------------- | ---------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DPSGD    | Differential Privacy   | [example](aijack_dp.ipynb)                                                                     | [paper](https://github.com/Koukyosyumei/AIJack/https://arxiv.org/abs/1607.00133)                                                                                                                          |
